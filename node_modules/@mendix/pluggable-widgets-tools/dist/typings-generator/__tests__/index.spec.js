...
const image_1 = require("./inputs/image");
const image_2 = require("./outputs/image");
describe("Generating tests", () => {
    ...
    it("Generates a parsed typing from XML for web using images", () => {
        const newContent = generateFullTypesFor(image_1.imageWebInput);
        expect(newContent).toBe(image_2.imageWebOutput);
    });
    it("Generates a parsed typing from XML for native using images", () => {
        const newContent = generateNativeTypesFor(image_1.imageNativeInput);
        expect(newContent).toBe(image_2.imageNativeOutput);
    });
});
